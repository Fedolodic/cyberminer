    ...
    search(lines, itemsToSearch, booleanSymbols) {
        ...
        shiftedWebPageData.forEach((data) => {
            ...
            if (booleanSymbols.length) {
                ...
                let andTruths = [];
                let finalTruths = [];
                booleanSymbols.forEach((symbol, index) => {
                    if (symbol === "NOT") {
                        truthTable[index] = !truthTable[index];
                        console.log("truthable after not:  ", truthTable);
                    }
                    else if (symbol === "AND")
                        ands.push(index);
                    else if (symbol === "OR")
